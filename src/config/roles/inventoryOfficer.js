/***
 * File name: inventoryOfficer.js
 *
 * Program Description:
 * User role privilegas for the role of `Inventory Officer`
 *
 * inventoryOfficer.js contains the specific settings for each route
...
module.exports = {
    label: 'Supply and Inventory Officer',
    roleType: 'Internal',
    privileges: [
        // account management
        'login',
